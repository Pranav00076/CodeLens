import { RepoAIContext, ChatMessage } from './provider.js';

export class PromptTemplates {
  static buildAnalysisPrompt(context: RepoAIContext): string {
...
`;
  ...
  static buildChatPrompt(context: RepoAIContext, history: ChatMessage[], question: string): string {
