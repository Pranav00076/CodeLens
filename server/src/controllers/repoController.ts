...
export class RepoController {
  static getRepo(req: Request, res: Response): void {
  ...
  static getAllRepos(req: Request, res: Response): void {
    const repos = dbService.getAllRepos();
    res.json({ success: true, data: repos });
  }

  static deleteRepo(req: Request, res: Response): void {
    const id = req.params.id as string;
  ...
  static async getFileContent(req: Request, res: Response): Promise<void> {
    ...
    const queryRepoName = req.query.repoName as string | undefined;
  ...
  static exportOnboardingMarkdown(req: Request, res: Response): void {
    const id = req.params.id as string;
    const repo = dbService.getRepo(id);
